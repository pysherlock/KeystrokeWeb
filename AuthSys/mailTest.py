...
def main():
    ...
    msg_body = '''Dear user,\n\n
                According to your login habit, our system changed your profile
                of Environmental Login to follow your new habit. \n\n
                Environmental Login Team'''


    message = CreateMessage(SRC_MAIL_ADDRESS, "pu_yang@outlook.com",
